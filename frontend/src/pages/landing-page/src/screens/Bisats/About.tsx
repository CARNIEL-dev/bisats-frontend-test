    ...
    <>
      <div>
        ...
        <div className="py-[64px] lg:py-[88px] flex flex-col items-center justify-center px-[20px]">
          <h2 className="text-[28px] lg:text-[42px] font-medium text-foreground lg-[8px] lg:mb-[24px]">
            About Us
          </h2>
          <p className=" text-muted-foreground lg:text-center w-full max-w-[808px]">
        ...
        <div className="lg:py-[90px] px-[20px] flex flex-col lg:flex-row items-center justify-between lg:justify-center gap-[48px] lg:gap-[159px]">
          <div className="w-full lg:max-w-[603px]">
            <h2 className="text-foreground font-medium text-[32px] text-center lg:text-left mb-[16px]">
          ...
          <div className="mb-[64px] lg:mb-0">
            <img
              src="/landingpage/About-us-image.png"
              alt="about-us-image"
