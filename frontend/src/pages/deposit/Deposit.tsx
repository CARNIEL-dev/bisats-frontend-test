...
const Deposit = () => {
  const [depositDetails, setDepositDetails] =
    useState<IDepositDetails>(defaultDeposits);
        ...
        <div className="w-[28%] pt-[60px]">
          <div style={{ lineHeight: "24px" }} className="mb-[20px]">
            ...
            <p style={{ color: "#515B6E", fontSize: "14px" }}>
              Securely deposit fiat or crypto to fund your account and start
              trading.
            </p>
          </div>
          ...
          {depositDetails.Network !== "" && depositDetails.Asset !== "XNGN" && (
            <div
              className="border border-dashed h-[84px] p-[16px] mb-[15px]"
              style={{
                borderColor: "#F59E0C",
                borderRadius: "12px",
                lineHeight: "24px",
            ...
            >
              <p
                style={{ color: "#2B313B", fontSize: "14px", fontWeight: 600 }}
              >
                Wallet Address
              </p>
              <p
                style={{ color: "#515B6E", fontSize: "14px", fontWeight: 400 }}
              >
                0x8708bcabde9d58fedcd164ebf0d3742486284b90
              </p>
            </div>
          )}
          {(depositDetails.Network !== "" ||
            depositDetails.Asset === "XNGN") && (
