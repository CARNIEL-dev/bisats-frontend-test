...
const Profile = () => {
	...
	return (
		<div>
			...
			<div className=" mt-20 w-full max-w-[1024px] mx-auto space-y-8 pb-[100px]">
				<div className="flex items-center my-10 mx-3">
					<h1 className="text-[28px] md:text-[34px] leading-[40px] font-[600] text-[#0A0E12] mr-4">
						{user?.userName}
					</h1>
					<svg
						width="16"
