      ...
      switch (item.type) {
        case "heading":
          ...
          return React.createElement(
            ...
            {
              key,
              className: `${className} ${headingSize} font-semibold text-foreground ${baseMargin}`,
            },
            item.content,
          );
              ...
              ...(item.listItems?.map((listItem, idx) =>
                React.createElement(
                  "li",
                  {
                    key: `${key}-item-${idx}`,
                    className: `
                    ${baseTextSize} text-muted-foreground font-normal leading-relaxed
                    list-disc list-inside
                  `,
                  },
                  listItem,
        ...
        case "code":
          return React.createElement(
            "pre",
            {
              ...
              bg-muted rounded-md p-3 overflow-x-auto
