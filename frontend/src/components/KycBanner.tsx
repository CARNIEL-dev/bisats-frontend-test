...
const KycBanner = () => {
  ...
  return (
    <div className="w-full bst-kyc-banner flex items-start py-5 px-7 rounded-[12px] ">
      ...
      <div className="mx-5">
        <h1 className=" text-white text-[14px] leading-[24px] lg:text-[28px] lg:leading-[40px] font-semibold">
          Unlock Full Access: Complete Your KYC
        </h1>
        <p className="text-[#C2C7D2] text-[12px] leading-[16px] py-1 lg:text-[16px] lg:leading-[28px] font-normal">
