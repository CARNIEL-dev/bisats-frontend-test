    ...
    return (
        <div className="w-full bst-kyc-banner flex items-start py-5 px-7 rounded-[12px] ">
            ...
            <div className="mx-5">
                ...
                <PrimaryButton text={"Complete KYC"} loading={false} css={"w-fit px-5"} onClick={() => !user.phoneNumberVerified ? navigate(APP_ROUTES.KYC.PHONEVERIFICATION) : navigate(APP_ROUTES.KYC.PERSONAL)} />
            </div>
