  ...
  return (
    <div className="w-full cursor-pointer">
      <div className="w-full relative cursor-pointer">
        ...
        <div className="relative w-full cursor-pointer " onClick={openCalendar}>
          {/* Hidden Date Input */}
          <input
            ref={dateInputRef}
            type="date"
          ...
          <div
            className={` cursor-pointer text-[#515B6E] p-3 bg-linear-to-r from-[#FFFFFF] to-[#EEEFF2] border border-[#E2E4E8] h-[48px] rounded-[8px] inline-flex items-center w-full font-semibold text-[14px] leading-[24px] placeholder-[#515B6E] focus:outline-hidden  ${
              error && touched
