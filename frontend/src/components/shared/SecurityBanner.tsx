...
const SecurityBanner = () => {
  return (
    <div className="bg-[#F5FEF8] p-2 border border-[#DCFCE7] rounded-[8px] text-xs text-[#17A34A] w-full h-fit flex items-start   ">
      <svg
        width="16"
        height="16"
        viewBox="0 0 16 16"
      ...
      <p className="w-[95%]">
        ...
        encrypted and protected using industry-leading security standards. Your
