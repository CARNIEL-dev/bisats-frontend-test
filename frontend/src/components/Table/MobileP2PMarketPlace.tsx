        ...
        <div className='w-full '>
            {
                data?.map((row, rowIndex) => (
                    <div style={rowIndex % 2 === 0 ? {} : { backgroundColor: "#F9F9FB" }} className='h-[106px] text-[14px] text-[#515B6E] p-2 w-full'>
                        <div className='w-full'>
                            <div className='w-full flex items-center justify-between text-[14px] font-[600] text-[#515B6E]'>
                            ...
                            <div className='flex justify-between items-end text-[12px] text-[#515B6E] '>
                                <div>
                                    ...
                                    <Link to={row?.orderType === "buy" ? APP_ROUTES.P2P.BUY : APP_ROUTES.P2P.SELL} state={{ adDetail: row }} className='flex justify-end'>
