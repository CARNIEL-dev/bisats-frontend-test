...
export const RedTransparentButton: React.FC<TButtons> = ({
	...
	return (
		<button
			type="submit"
			className={`h-[48px] rounded-[6px] bg-transparent text-[#DC2625] text-[14px] leading-[24px] font-[600] text-center py-3`}
			{...props}
		>
			{loading ? (
				<DotLoader
...
export const WhiteTransparentButton: React.FC<TButtons> = ({
	...
	return (
		<button
			...
			}  rounded-[6px] bg-transparent text-[#525C76] border-[1px] border-[#D6DAE1]  leading-[24px] font-[600] text-center`}
			{...props}
		>
			{loading ? (
				<DotLoader
