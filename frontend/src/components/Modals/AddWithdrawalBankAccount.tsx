...
import { AddBankAccountForWithdrawal, GetBankList } from "../../redux/actions/walletActions";
    ...
    return (
        <ModalTemplate onClose={close}>
            <div className='relative pt-10'>
                ...
                <div className="my-5">
                    <MultiSelectDropDown title={"Select Bank"} choices={choices} error={undefined} touched={undefined} label={"Bank"} scrollHeight={"200px"}
                    ...
                    <PrimaryInput css={"w-full py-2"} label={"Account Name"} error={!CheckNameMatch()} touched={!CheckNameMatch()}
                ...
                <div className='flex items-center w-full mt-5'>
                    ...
                    <PrimaryButton text={'Save Account'} loading={isLoading} css='w-1/2 ml-3' onClick={AddBankAccount} />
                </div>
            </div>
        </ModalTemplate>
    )
