            ...
            <div className="flex flex-col justify-center w-full  mx-auto">
                ...
                <form className="mt-5">
                    <div className="relative mb-4">
                        ...
                        <PrimaryInput css={"w-full p-2.5"} label={"Autheticator app code"} placeholder="Enter code" error={undefined} touched={undefined} onChange={(e)=>setCode(e.target.value)} />
                    </div>
                    <PrimaryInput css={"w-full p-2.5 mb-7"} label={"Wallet PIN"} placeholder="Enter PIN" error={undefined} touched={undefined} onChange={(e) => setPin(e.target.value)} />

                    <PrimaryButton css={"w-full"} text={"Confirm"} loading={loading} onClick={handleVerify} disabled={loading} />
                </form>
