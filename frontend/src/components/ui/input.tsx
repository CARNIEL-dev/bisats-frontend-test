  ...
  return (
    <input
      ...
      className={cn(
        ...
        "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive focus:border-primary focus:shadow-[0_0_4px_#FEF8E5]",
        className,
      )}
      {...props}
    />
