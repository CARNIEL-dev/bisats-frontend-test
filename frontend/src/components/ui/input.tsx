  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-PriYellow focus-visible:PriYellow/50 focus-visible:ring-0",
        "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive focus:border-primary focus:shadow-[0_0_10px_#FEF8E5]",
        className
      )}
      {...props}
    />
