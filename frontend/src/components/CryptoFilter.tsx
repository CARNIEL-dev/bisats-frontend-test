  ...
  return (
    <div className="w-full relative">
      <button
        ...
        className={`text-[#515B6E] p-2.5 px-4 bg-linear-to-r from-[#FFFFFF] to-[#EEEFF2] border border-[#E2E4E8] h-[48px] rounded-[8px]  items-center w-[120px] flex justify-between font-semibold text-[14px] leading-[24px] ${
          error && touched
      ...
      >
        ...
        <div className="mx-3">{selected.tokenName}</div>
        {/* </Typography.Text> */}
        ...
        >
          <path
            d="M5.99865 4.97656L10.1236 0.851562L11.302 2.0299L5.99865 7.33323L0.695312 2.0299L1.87365 0.851562L5.99865 4.97 656Z"
            fill="#525C76"
          />
        </svg>
      </button>
      ...
      <div
        // ref={root}
        id={`tokenSelectBtn`}
        className={`absolute mt-1 z-10 transition-all duration-150 ease ${
          isDropdownOpen
